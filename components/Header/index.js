                ...
                <div className={`w-full h-[70vmin] flex align-center items-center justify-center flex-row p-[20px] flex-wrap mt-[50px]`}>
                    <div className={`w-full h-full mb-[50px] relative md:w-[50%]`}>
                        <div className={``}>
                            ...
                            <br />
                            <br />
                            <h1 className={` text-[9vmin] md:text-[5vmin] text-gray-400`}>Hello, I am</h1>
                            <h1 data-aos="fade-right" className={` text-[10vmin] md:text-[8vmin]`}>
                                {usersInfo.full_name}
                            </h1>
                            <br />
                        ...
                        <div className="w-full h-auto mt-[60px]">
                            <br />
                            <button className="w-[150px] border-[2px] border-solid border-green-200 px-5 py-3 bg-dark-100 rounded-[30px] scale-[.90] hover:scale-[.95] transition-all  " onClick={openResume}>View Resume</button>
                        </div>
